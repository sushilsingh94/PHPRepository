		...
		<div id="main">
			...
			<?php  $values =Post::get_posts() ; ?>
				...
				<?php echo $value = $values->current();?>
					<a
						href="<?php echo base_url('home/' . $value->data['slug'])?>"
						rel="bookmark"><div class="main-story-shade">
							<img width="620" height="410"
								src="../../images/<?php echo $value->data['slug']?>.jpg"
						...
						<?php if(has_posts()): ?>
							...
							<li class="home-widget"><span class="home-widget-header"><h3
								...
								<div class="cat-light-bottom cat-light-links">
									...
									<ul>
									<?php $cat_post = Post::get_posts(2);?>
										<?php $i = 0; while($i<$cat_post->length()): ?>
										<?php $post = $cat_post->current();?>   <!-- need to get post based on category : method getPostByCategory will
										return post based on category -->
										<?php $bg = sprintf('background: hsl(215, 28%%, %d%%);', round(((++$i / posts_per_page()) * 20) + 20)); ?>
											<li><a href="<?php echo post_url($post); ?>"><img width="85"
												height="54"
												src="../../images/<?php echo $post->data['slug'];?>-85x54.jpg"
												class="attachment-small-thumb wp-post-image"
												alt="<?php echo $post->data['title']; ?>"></a> <span
											class="list-byline"><a href="#"
												title="<?php echo $post->data['author_name']; ?>"
												rel="author"><?php echo $post->data['author_name']; ?></a>
												| August 14, 2014</span>
											<p>
												<a href="<?php echo post_url($post); ?>"><?php echo $post->data['title']; ?></a>
											</p></li>
											<?php $cat_post->next();?>
												<?php endwhile; ?>
										</ul>
